package com.test.zha.redis_test_new.controller;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.test.zha.redis_test_new.bean.ChidainshaDetail;
import com.test.zha.redis_test_new.config.DefaultRedisDataSourceInfo;
import com.test.zha.redis_test_new.config.SecondRedisDataSourceInfo;
import com.test.zha.redis_test_new.util.RedisUtils;
...
/*
        List<ChidainshaDetail> chidainshaDetailList = new ArrayList<>();
        ChidainshaDetail detail = new ChidainshaDetail("source", "bussinessId");
        ChidainshaDetail detail2 = new ChidainshaDetail("中文1", "中文2");
        chidainshaDetailList.add(detail);
        chidainshaDetailList.add(detail2);

        RedisUtils.setValue("21", chidainshaDetailList);
*/
